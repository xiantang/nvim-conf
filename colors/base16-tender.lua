...
hi(0, "NERDTreeFile", { fg = "#F9FAFA" })
hi(0, "NERDTreeCWD", { fg = "#F9FAFA" })
...
hi(0, "TSOperator", { fg = "#F9FAFA" })
hi(0, "TSParameter", { fg = "#F9FAFA" })
hi(0, "TSParameterReference", { fg = "#eeeeee" })
hi(0, "TSProperty", { fg = "#F6C87B" })
hi(0, "TSPunctBracket", { fg = "#F9FAFA" })
