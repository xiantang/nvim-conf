...
hi(0, "BufferDefaultCurrent", { bg = "#2B2B2B", ctermfg = 255, fg = "#eeeeee" })
hi(0, "BufferDefaultCurrentERROR", { bg = "#2B2B2B", ctermfg = 15, fg = "#f43753" })
hi(0, "BufferDefaultCurrentHINT", { bg = "#2B2B2B", ctermfg = 168, fg = "#d5508f" })
hi(0, "BufferDefaultCurrentINFO", { bg = "#2B2B2B", ctermfg = 217, fg = "#ffb7b7" })
hi(0, "BufferDefaultCurrentIndex", { bg = "#2B2B2B", ctermfg = 224, fg = "#73cef4" })
hi(0, "BufferDefaultCurrentMod", { bg = "#2B2B2B", ctermfg = 224, fg = "#f43753" })
hi(0, "BufferDefaultCurrentSign", { bg = "#2B2B2B", ctermfg = 224, fg = "#73cef4" })
hi(0, "BufferDefaultCurrentTarget", { bg = "#2B2B2B", bold = true, ctermfg = 9, fg = "#ff0000" })
hi(0, "BufferDefaultCurrentWARN", { bg = "#2B2B2B", ctermfg = 224, fg = "#f43753" })
...
hi(0, "CmpDocumentation", { bg = "#2B2B2B", fg = "#eeeeee" })
hi(0, "CmpDocumentationBorder", { bg = "#2B2B2B", fg = "#eeeeee" })
...
hi(0, "Conceal", { bg = "#2B2B2B", ctermbg = 242, ctermfg = 7, fg = "#b3deef" })
...
hi(0, "DiffAdd", { bg = "#2B2B2B", ctermbg = 4, fg = "#c9d05c" })
hi(0, "DiffAdded", { bg = "#2B2B2B", fg = "#c9d05c" })
hi(0, "DiffChange", { bg = "#2B2B2B", ctermbg = 5, fg = "#4c4c4c" })
hi(0, "DiffDelete", { bg = "#2B2B2B", bold = true, ctermbg = 6, ctermfg = 12, fg = "#f43753" })
hi(0, "DiffFile", { bg = "#2B2B2B", fg = "#f43753" })
hi(0, "DiffLine", { bg = "#2B2B2B", fg = "#b3deef" })
hi(0, "DiffNewFile", { bg = "#2B2B2B", fg = "#c9d05c" })
hi(0, "DiffRemoved", { bg = "#2B2B2B", fg = "#f43753" })
hi(0, "DiffText", { bg = "#2B2B2B", bold = true, ctermbg = 9, fg = "#b3deef" })
hi(0, "Directory", { ctermfg = 159, fg = "#b3deef" })
hi(0, "Error", { bg = "#f43753", ctermbg = 9, ctermfg = 15, fg = "#2B2B2B" })
hi(0, "ErrorMsg", { bg = "#2B2B2B", ctermbg = 1, ctermfg = 15, fg = "#f43753" })
...
hi(0, "FloatBorder", { bg = "#2B2B2B", fg = "#eeeeee" })
hi(0, "FocusedSymbol", { bg = "#383838", fg = "#c9d05c" })
hi(0, "FoldColumn", { bg = "#2B2B2B", ctermbg = 242, ctermfg = 14, fg = "#73cef4" })
...
hi(0, "HopUnmatched", { bg = "#2B2B2B", ctermfg = 242, fg = "#666666", sp = "#666666" })
...
hi(0, "LineNr", { bg = "#2B2B2B", ctermfg = 11, fg = "#b8b8b8" })
...
hi(0, "NERDTreeFile", { fg = "#B2B2B2" })
hi(0, "NERDTreeCWD", { fg = "#B2B2B2" })
...
hi(0, "NormalFloat", { bg = "#2B2B2B", fg = "#eeeeee" })
hi(0, "NormalNC", { bg = "#2B2B2B", fg = "#eeeeee" })
...
hi(0, "SignColumn", { bg = "#2B2B2B", ctermbg = 242, ctermfg = 14, fg = "#b8b8b8" })
...
hi(0, "TSOperator", { fg = "#B2B2B2" })
hi(0, "TSParameter", { fg = "#B2B2B2" })
hi(0, "TSParameterReference", { fg = "#eeeeee" })
hi(0, "TSProperty", { fg = "#F6C87B" })
hi(0, "TSPunctBracket", { fg = "#B2B2B2" })
...
hi(0, "VertSplit", { bg = "#2B2B2B", fg = "#eeeeee" })
