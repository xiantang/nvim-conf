...
hi(0, "Normal", { bg = "#282828", fg = "#eeeeee" })
...
hi(0, "TSComment", { fg = "#4c4c4c", italic = true })
hi(0, "TSConditional", { fg = "#d3b987" })
hi(0, "TSConstBuiltin", { fg = "#dc9656", italic = true })
hi(0, "TSConstMacro", { fg = "#f43753" })
hi(0, "TSConstant", { fg = "#dc9656" })
...
hi(0, "TSField", { fg = "#eeeeee" })
hi(0, "TSFloat", { fg = "#dc9656" })
hi(0, "TSFuncBuiltin", { fg = "#b3deef", italic = true })
hi(0, "TSFuncMacro", { fg = "#f43753" })
hi(0, "TSFunction", { fg = "#b3deef" })
hi(0, "TSInclude", { fg = "#b3deef" })
hi(0, "TSKeyword", { fg = "#d3b987" })
hi(0, "TSKeywordFunction", { fg = "#d3b987" })
hi(0, "TSKeywordOperator", { fg = "#d3b987" })
hi(0, "TSLabel", { fg = "#ffc24b" })
hi(0, "TSLiteral", { fg = "#dc9656" })
hi(0, "TSMethod", { fg = "#b3deef" })
hi(0, "TSNamespace", { fg = "#f43753" })
hi(0, "TSNone", { fg = "#eeeeee" })
hi(0, "TSNumber", { fg = "#dc9656" })
hi(0, "TSOperator", { fg = "#eeeeee" })
hi(0, "TSParameter", { fg = "#eeeeee" })
hi(0, "TSParameterReference", { fg = "#eeeeee" })
hi(0, "TSProperty", { fg = "#eeeeee" })
hi(0, "TSPunctBracket", { fg = "#eeeeee" })
