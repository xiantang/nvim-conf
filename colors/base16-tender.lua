...
hi(0, "BufferDefaultCurrent", { bg = "#303030", ctermfg = 255, fg = "#eeeeee" })
hi(0, "BufferDefaultCurrentERROR", { bg = "#303030", ctermfg = 15, fg = "#f43753" })
hi(0, "BufferDefaultCurrentHINT", { bg = "#303030", ctermfg = 168, fg = "#d5508f" })
hi(0, "BufferDefaultCurrentINFO", { bg = "#303030", ctermfg = 217, fg = "#ffb7b7" })
hi(0, "BufferDefaultCurrentIndex", { bg = "#303030", ctermfg = 224, fg = "#73cef4" })
hi(0, "BufferDefaultCurrentMod", { bg = "#303030", ctermfg = 224, fg = "#f43753" })
hi(0, "BufferDefaultCurrentSign", { bg = "#303030", ctermfg = 224, fg = "#73cef4" })
hi(0, "BufferDefaultCurrentTarget", { bg = "#303030", bold = true, ctermfg = 9, fg = "#ff0000" })
hi(0, "BufferDefaultCurrentWARN", { bg = "#303030", ctermfg = 224, fg = "#f43753" })
...
hi(0, "CmpDocumentation", { bg = "#303030", fg = "#eeeeee" })
hi(0, "CmpDocumentationBorder", { bg = "#303030", fg = "#eeeeee" })
...
hi(0, "Conceal", { bg = "#303030", ctermbg = 242, ctermfg = 7, fg = "#b3deef" })
...
hi(0, "Cursor", { bg = "#eeeeee", fg = "#303030" })
...
hi(0, "DiffAdd", { bg = "#303030", ctermbg = 4, fg = "#c9d05c" })
hi(0, "DiffAdded", { bg = "#303030", fg = "#c9d05c" })
hi(0, "DiffChange", { bg = "#303030", ctermbg = 5, fg = "#4c4c4c" })
hi(0, "DiffDelete", { bg = "#303030", bold = true, ctermbg = 6, ctermfg = 12, fg = "#f43753" })
hi(0, "DiffFile", { bg = "#303030", fg = "#f43753" })
hi(0, "DiffLine", { bg = "#303030", fg = "#b3deef" })
hi(0, "DiffNewFile", { bg = "#303030", fg = "#c9d05c" })
hi(0, "DiffRemoved", { bg = "#303030", fg = "#f43753" })
hi(0, "DiffText", { bg = "#303030", bold = true, ctermbg = 9, fg = "#b3deef" })
hi(0, "Directory", { ctermfg = 159, fg = "#b3deef" })
hi(0, "Error", { bg = "#f43753", ctermbg = 9, ctermfg = 15, fg = "#303030" })
hi(0, "ErrorMsg", { bg = "#303030", ctermbg = 1, ctermfg = 15, fg = "#f43753" })
...
hi(0, "FloatBorder", { bg = "#303030", fg = "#eeeeee" })
hi(0, "FocusedSymbol", { bg = "#383838", fg = "#c9d05c" })
hi(0, "FoldColumn", { bg = "#303030", ctermbg = 242, ctermfg = 14, fg = "#73cef4" })
hi(0, "Folded", { bg = "#383838", ctermbg = 242, ctermfg = 14, fg = "#4c4c4c" })
hi(0, "Function", { fg = "#b3deef" })
hi(0, "GitGutterAdd", { bg = "#303030", fg = "#c9d05c" })
hi(0, "GitGutterChange", { bg = "#303030", fg = "#b3deef" })
hi(0, "GitGutterChangeDelete", { bg = "#303030", fg = "#d3b987" })
hi(0, "GitGutterDelete", { bg = "#303030", fg = "#f43753" })
hi(0, "GitSignsStagedAdd", { bg = "#303030", fg = "#64682e" })
hi(0, "GitSignsStagedAddLn", { bg = "#303030", fg = "#64682e" })
hi(0, "GitSignsStagedAddNr", { bg = "#303030", fg = "#64682e" })
hi(0, "GitSignsStagedChange", { bg = "#303030", fg = "#596f77" })
hi(0, "GitSignsStagedChangeLn", { bg = "#303030", fg = "#262626" })
hi(0, "GitSignsStagedChangeNr", { bg = "#303030", fg = "#596f77" })
hi(0, "GitSignsStagedChangedelete", { bg = "#303030", fg = "#596f77" })
hi(0, "GitSignsStagedChangedeleteLn", { bg = "#303030", fg = "#262626" })
hi(0, "GitSignsStagedChangedeleteNr", { bg = "#303030", fg = "#596f77" })
hi(0, "GitSignsStagedDelete", { bg = "#303030", fg = "#7a1b29" })
hi(0, "GitSignsStagedDeleteNr", { bg = "#303030", fg = "#7a1b29" })
hi(0, "GitSignsStagedTopdelete", { bg = "#303030", fg = "#7a1b29" })
hi(0, "GitSignsStagedTopdeleteNr", { bg = "#303030", fg = "#7a1b29" })
...
hi(0, "HopUnmatched", { bg = "#303030", ctermfg = 242, fg = "#666666", sp = "#666666" })
hi(0, "Identifier", { ctermfg = 14, fg = "#f43753" })
hi(0, "Ignore", { ctermfg = 0, fg = "#303030" })
...
hi(0, "LineNr", { bg = "#303030", ctermfg = 11, fg = "#b8b8b8" })
...
hi(0, "NormalFloat", { bg = "#303030", fg = "#eeeeee" })
hi(0, "NormalNC", { bg = "#303030", fg = "#eeeeee" })
...
hi(0, "NvimInternalError", { bg = "#f43753", ctermbg = 9, ctermfg = 9, fg = "#303030" })
...
hi(0, "SignColumn", { bg = "#303030", ctermbg = 242, ctermfg = 14, fg = "#b8b8b8" })
...
hi(0, "TSStrike", { fg = "#303030", strikethrough = true })
...
hi(0, "TSUnderline", { fg = "#303030", underline = true })
hi(0, "TSVariable", { bg = "#303030", fg = "#c3cedb" })
...
hi(0, "TermCursor", { bg = "#eeeeee", fg = "#303030" })
hi(0, "TermCursorNC", { bg = "#eeeeee", fg = "#303030" })
...
hi(0, "User8", { bg = "#484848", fg = "#303030" })
hi(0, "User9", { bg = "#484848", fg = "#303030" })
hi(0, "VertSplit", { bg = "#303030", fg = "#eeeeee" })
...
hi(0, "lCursor", { bg = "#eeeeee", fg = "#303030" })
